/// MODULE 4 - Processing and cleaning data ///

> Organizing and cleaning data is a crucial process of the data analysis

- Remain the data analysis general process: 
    * Ask
    * Prepare
    * Process
    * Analyze
...
- DATA INTEGRITY: The acuraccy, completeness, consistency, and trustworthiness of data throughout its lifecycle.
